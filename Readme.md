...
Click Add and select the BoyRun folder.

Open the project (Recommended Unity Version: 2021.3 or later).

Open the scene located in Assets/Scenes/GamePlay.unity.
